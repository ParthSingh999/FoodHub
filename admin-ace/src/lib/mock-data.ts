...
export const reviews: Review[] = [
  {
    ...
    rating: 5,
    comment: "Butter chicken was 🔥, delivered hot!",
    dish: "Butter Chicken",
    date: "2026-07-08",
    replied: true,
  },
  {
    ...
    rating: 4,
    comment: "Biryani portion could be bigger.",
  ...
  },
  {
    ...
    rating: 5,
    comment: "Loved the paneer tikka marinade.",
    dish: "Paneer Tikka",
    date: "2026-07-05",
    replied: true,
  },
  {
    ...
    customer: "Vikram Rao",
    rating: 3,
    comment: "Average taste, quick delivery though.",
    dish: "Cheese Burger",
    date: "2026-07-04",
    replied: false,
  },
...
export const ads: Ad[] = [
  {
    id: "A1",
    title: "Monsoon Biryani Combo 20% Off",
    type: "Banner",
    status: "Active",
    budget: 5000,
    spent: 3240,
  ...
  {
    id: "A3",
    title: "Weekend Push Notification",
    type: "Push",
    status: "Paused",
    budget: 2000,
    spent: 1200,
...
export const walletTxns: WalletTxn[] = [
  { id: "T1", date: "2026-07-10", desc: "Payout to bank ****4521", type: "debit", amount: 25000 },
  {
    id: "T2",
    date: "2026-07-09",
    desc: "Orders settlement (48 orders)",
    type: "credit",
    amount: 18420,
  },
  { id: "T3", date: "2026-07-08", desc: "Ad spend – Featured", type: "debit", amount: 2400 },
  {
    id: "T4",
    date: "2026-07-07",
    desc: "Orders settlement (52 orders)",
    type: "credit",
    amount: 21200,
  },
  { id: "T5", date: "2026-07-06", desc: "Refund – Order #ZM4991", type: "debit", amount: 320 },
  {
    id: "T6",
    date: "2026-07-05",
    desc: "Orders settlement (39 orders)",
    type: "credit",
    amount: 15900,
  },
];
