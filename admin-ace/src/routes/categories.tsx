...
export const Route = createFileRoute("/categories")({
  head: () => ({
    meta: [
      { title: "Categories - Zamato Partner" },
      { name: "description", content: "Organize your menu into categories customers can browse." },
    ],
  }),
            ...
            <form onSubmit={createCategory} className="space-y-4">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  placeholder="Fast Food, Lunch, Dinner"
                  required
                />
              </div>
              <div className="space-y-2">
            ...
            <CardContent className="p-5">
              <div className="flex items-start justify-between">
                ...
                <Badge
                  ...
                  className={c.active ? "bg-success text-success-foreground" : ""}
                >
              ...
              <div className="mt-4 flex items-center justify-between border-t border-border pt-4">
                <div className="flex items-center gap-2">
                  <Switch
                    checked={c.active}
                    onCheckedChange={(active) => toggleCategory(c, active)}
                  />
