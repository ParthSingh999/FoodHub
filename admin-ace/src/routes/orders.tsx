...
export const Route = createFileRoute("/orders")({
  head: () => ({
    meta: [
      { title: "Orders — Zamato Partner" },
      { name: "description", content: "Live orders and full order history for your restaurant." },
    ],
  }),
    ...
    <AppShell title="Orders" subtitle="Track and manage all customer orders">
      ...
      <div className="mt-6 grid gap-4 lg:grid-cols-2">
        {filtered.map((o) => (
          <Card
            key={o.id}
            className="border-border/60 shadow-[var(--shadow-card)] transition hover:shadow-lg"
          >
