...
export const Route = createFileRoute("/ads")({
  head: () => ({
    meta: [
      { title: "Ads & Promotions — Zamato Partner" },
      {
        name: "description",
        content: "Create and manage banner ads, featured listings and push campaigns.",
      },
    ],
  }),
  component: AdsPage,
                ...
                <div className="flex items-start justify-between gap-3">
                  <div className="min-w-0">
                    <div className="flex flex-wrap items-center gap-2">
                      ...
                      <span
                        className={`rounded-full border px-2 py-0.5 text-xs font-medium ${tone[a.status]}`}
                      >
                        {a.status}
                      </span>
                    </div>
                ...
                <div className="mt-4">
                  <div className="flex items-center justify-between text-xs">
                    ...
                    <span className="font-semibold">
                      ₹{a.spent.toLocaleString()} / ₹{a.budget.toLocaleString()}
                    </span>
                  </div>
