        ...
        <aside className="space-y-2">
          {steps.map((s, i) => {
            ...
            return (
              ...
              >
                <div
                  className={`flex h-9 w-9 shrink-0 items-center justify-center rounded-lg ${done ? "bg-success text-success-foreground" : active ? "bg-primary text-primary-foreground" : "bg-muted text-muted-foreground"}`}
                >
              ...
              <>
                ...
                <div className="grid gap-4 sm:grid-cols-3">
                  ...
                  <Field
                    label="Opens at"
                    value={form.opensAt}
                    onChange={(value) => updateField("opensAt", value)}
                  />
                </div>
                <Field
                  label="Closes at"
                  value={form.closesAt}
                  onChange={(value) => updateField("closesAt", value)}
                />
              </>
            )}
            {step === 2 && (
              <>
                <Field
                  ...
                  value={form.fssai}
                  onChange={(value) => updateField("fssai", value)}
                />
                <div className="grid gap-4 sm:grid-cols-2">
                  <Field
                    label="GST Number"
                    value={form.gst}
                    onChange={(value) => updateField("gst", value)}
                  />
                  <Field
                    label="PAN Number"
                    value={form.pan}
